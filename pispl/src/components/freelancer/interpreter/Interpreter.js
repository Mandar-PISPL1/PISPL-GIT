...
export default function Interpreter() {
  ...
  function Submit(e) {
    ...
    fetch(
      "https://script.google.com/macros/s/AKfycbxA7oNaAcc6iyLNRSmiSkYXpx_5AYB2eqtv0wJEA0Pp5H2jX7X1idwRrOjUmDgZzdX7Tw/exec",
  ...
  return (
    <>
      {/* <div className="container w-50 width100">
        ...
        { page < 4 && <button type="submit" style={btnStyle} onClick={next} className="col-md-6 btn btn-primary my-2 py-3">NEXT</button> }
            { page > 1 && <button type="submit" style={btnStyle} onClick={prev} className="col-md-6 btn btn-primary my-2 py-3">PREVIOUS</button> }
            {page===4 && <button type="submit" style={btnStyle}  className="col-md-6 btn btn-primary my-2 py-3">SUBMIT</button>}
          </div>
      </div> */}
      <div className="container w-50 width100">
        ...
        <form className="form" onSubmit={(e) => Submit(e)}>
          ...
          <div className="my-2">
            ...
            <input type="text" className="form-control form-control-lg w-100 rounded border-secondary" name="Simultaneous_Interpretation_Rate_Per_Day" />
          </div>
          <div className="my-2">
            ...
            <input type="text" className="form-control form-control-lg w-100 rounded border-secondary"
              name="Consecutive_Interpretation_Rate_Per_Day" />
          </div>
          <div className="my-0">
