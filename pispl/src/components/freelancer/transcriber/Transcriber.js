...
export default function Transcriber() {
  // https://script.google.com/macros/s/AKfycbyKfvKjIq1wAq3UXwROsAwATnAgYvFmCpcMFqNPRhhQ_VJSJpcN4Xt4MKsj_VwFDpjW/exec
  function Submit(e) {
        ...
        <div className="container w-50 width100">
          ...
          <div className="row my-2">
            <div className="col-12">
              ...
              <select class="form-select form-select-lg border-secondary" id="exampleFormControlSelect1" name='Native_Language'>
                <option value="Science">Select Native Language </option>
          ...
          <div className="col-12">
            <label for="exampleFormControlSelect1" className="pb-2 normal-text">Currency</label>
            <select class="form-select form-select-lg border-secondary" id="exampleFormControlSelect1" name="Currency">
          ...
          <div className="my-2">
            ...
            <input type="text" className="form-control form-control-lg w-100 rounded border-secondary" name="Same_Language_Transcription_Rate_Per_Minute" />
          </div>
          <div className="my-2">
            <label for="inputEmail4" className="pb-2 normal-text">Direct Native To English Transcription (Per Minute)
            </label>
            <input type="text" className="form-control form-control-lg w-100 rounded border-secondary" name="Direct_Native_To_English_Transcription_Per_Minute" />
          </div>
          <div className="my-2">
            <label for="inputEmail4" className="pb-2 normal-text">Daily Transcription Output (In Minutes)</label>
            <input type="text" className="form-control form-control-lg w-100 rounded border-secondary" name="Daily_Transcription_Output_In_Minute" />
          </div>
          ...
          <div class="form-check">
            <input checked class="form-check-input border-secondary" type="radio" name="Do_You_Work_on_Weekends" id="exampleRadios1" value="Yes" />
            <label class="form-check-label" for="exampleRadios1">
              Yes
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input border-secondary" type="radio" name="Work_on_weekend" id="exampleRadios2" value="No" />
