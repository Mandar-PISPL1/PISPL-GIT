    ...
    <>
      ...
      <div className="conatiner py-4 mx-md-2">
        <div className="row px-md-5 mx-md-5 m-0">
          <div className="col-md-6 col-12">
            <p className='text-start mx-3 my-0' style={{ color: "#0d2366", fontWeight: "300" }} >IN THE DIGITAL WORLD WITH UNIQUE CONTENT!</p>
            <h3 className='text-start mx-3 ml-2 h1' style={{ color: "#0d2366", fontWeight: "700" }}>Stand Out and Grow Your Business</h3>
            <div className='my-4 mx-3' style={{ width: "40px", backgroundColor: "#49dab5", height: "5px" }}></div>
            <p className='text-start m-3 normal-text'>At Parikh Info Solutions, we have a team of professional writers, digital marketing experts and project managers to <a href="https://parikhinfosolutions.com/blog/why-does-your-business-needs-content-writing-services/" className='text-danger'>implement the perfect content strategy</a> for your businesses. Our skilled writers can deliver content copies on different niche topics and multiple industries with excellent proficiency. With the perfect blend of creativity and technical skills, our professional writers can hit the right note with the audience and enhance your brand's message.<br /><br />Along with this, we also provide translation services in over 50+ languages to help your content reach global audiences. We're a one-stop solution for all your needs.
      ...
      {/* Content Writing Services We Offer */}
        <div className="conatiner py-4 mx-md-5">
          <div className="row px-md-5 mx-md-5 m-0" style={{border: "2px dashed #49dab5", padding: "30px"}}>
            <h2 className='text-center m-3 ml-2 h1' style={{ color: "#0d2366", fontWeight: "700" }}>Content Writing Services We Offer</h2>
            <div className="col-md-6 col-12 my-md-5 px-md-5 px-3" style={{borderRight:"2px dashed #333333"}}>
      ...
      <div className="conatiner py-4 mx-md-2 my-5">
        <div className="row px-md-5 mx-md-5 m-0">
          ...
          <h3 className='text-start mx-3 ml-2 h1' style={{ color: "#0d2366", fontWeight: "700" }}>SEO Optimized Content to Rank Higher</h3>
            ...
            <button className='mx-3' data-bs-toggle="modal" data-bs-target="#exampleModal" style={buttonstyle}>Contact Us <BsArrowRightCircle /> </button>
          </div>
          <div className="col-md-6 col-12 d-flex align-items-center justify-content-center">
      ...
      <div className='container-fluid py-5' style={{ backgroundImage: "linear-gradient(#85A3FF,#EEF4FF00,#85A3FF)" }}>
        ...
        <div className='container'>
          <div className='row justify-content-center'>
            <div className='mx-5 mb-4 mb-md-0 d-flex justify-content-center align-items-center' style={{ width: "12rem", border: "2px dashed #0D2366", textAlign: "center" }}>
      ...
      <div className='container my-4'>
        <div className='row justify-content-evenly mx-2'>
          <div className='col-12 my-4'>
            <h3 className='h1 text-center' style={{ color: "#0d2366", fontWeight: "600" }}>Why Choose Our Content Writing Services?</h3>
          </div>
          <div className='col-md-3 my-3 d-flex justify-content-center'>
            <div className="card py-2 shadow-sm px-1 h-100 align-items-center">
              <div className="card-body">
                <h5 className="card-title h4 text-center text-decoration-underline" style={{ color: "#0d2366"}}>Cost-Efficient</h5>
          ...
          <div className='col-md-3 my-3'>
            <div className="card py-2 shadow-sm px-1 h-100 align-items-center">
              <div className="card-body">
                <h5 className="card-title h4 text-center text-decoration-underline" style={{ color: "#0d2366"}}>High-Quality</h5>
          ...
          <div className='col-md-3 my-3'>
            <div className="card py-2 shadow-sm px-1 h-100 align-items-center">
              <div className="card-body">
                <h5 className="card-title h4 text-center text-decoration-underline" style={{ color: "#0d2366"}}>SEO Optimization</h5>
      ...
      <div className='container my-4'>
        <div className='row justify-content-evenly mx-2'>
          <div className='col-md-3 my-3'>
            <div className="card py-2 shadow-sm px-1 h-100 align-items-center">
              <div className="card-body">
                <h5 className="card-title h4 text-center text-decoration-underline" style={{ color: "#0d2366"}}>Team of Experts</h5>
          ...
          <div className='col-md-3 my-3'>
            <div className="card py-2 shadow-sm px-1 h-100 align-items-center">
              <div className="card-body">
                <h5 className="card-title h4 text-center text-decoration-underline" style={{ color: "#0d2366"}}>Time-Saving</h5>
          ...
          <div className='col-md-3 my-3'>
            <div className="card py-2 shadow-sm px-1 h-100 align-items-center">
              <div className="card-body">
                <h5 className="card-title h4 text-center text-decoration-underline" style={{ color: "#0d2366"}}>Research & Editing</h5>
