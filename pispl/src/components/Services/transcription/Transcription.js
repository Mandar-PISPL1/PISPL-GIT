...
export default function Transcription() {
  ...
  return (
    <>
      ...
      <div className="conatiner py-4 mx-md-2">
        <div className="row px-md-5 mx-md-5 m-0">
        <h2 className='text-center m-3' style={{ color: "#0d2366", fontWeight: "700" }} >Get Your Transcription Done in 4 Easy Steps</h2>
        <p className='text-center m-3' style={{ color: "#0d2366", fontWeight: "300" }} >With skilled and proficient transcribers, you can expect a comprehensive breakdown of the entire audio/video file into a cognitive language.</p>
        </div>
