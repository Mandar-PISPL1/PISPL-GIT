                ...
                <div className=' py-4 mx-md-5 px-md-5 d-flex justify-content-center'>
                    <div className='row px-md-5 mx-md-5 m-0 width100' style={{ width: "72%" }}>
                        ...
                        <div className='p-0 d-flex  justify-content-between phoneFlex'>
                            ...
                            <div><button style={{ backgroundColor: "#0d2366", color: "#49dab5", border: "2px solid #49dab5", padding: "3px 32px" }}>{blog.attributes.CategoryName}</button></div>
                ...
                <div className='row'>
                    ...
                    <div className='col-md-7 col-12'>
                        ...
                        <div id='blog-page-contain'>
                            <ReactMarkdown className='line-break blog-content px-md-5' >{blog.attributes.blogContent}</ReactMarkdown>
