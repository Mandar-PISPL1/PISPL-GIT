    ...
    <div style={{ overflowX: "hidden" }}>
      ...
      <div className='container py-3' style={{ overflowX: "hidden" }}>
        <div className='row' style={{ margin: "4% 8%" }} >
          <div className='col-md-6 col-12' style={{ color: "#0d2366" }}>
            ...
            <p style={{fontWeight:"300",fontSize:"18px"}}>Our passionate team of professionals works around the clock to provide the highest quality services for all projects. Dedicated to offering the best language service, we at Parikh Info Solutions cater to all language-related needs and requirements with utmost professionalism.<br/><br/>
      ...
      <div className='container py-3' >
        <div style={{ margin: "4% 8%", color: "#0d2366" }}>
          ...
          <p style={{fontWeight:"300",fontSize:"18px"}}>Parikh Info Solutions is a leading professional language service provider with decades of experience in the field and industry experts in all aspects. Keeping it up with the latest updates & dynamic industry trends, we, at Parikh Info Solutions, strive to serve the best to all our clients across the globe.</p>
        </div>
        <div className='container' >
